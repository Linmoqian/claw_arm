...
结合 Claude Code / OpenClaw，用**自然语言**控制机械臂
...
| 📷 摄像头 | USB 1080p 或 RealSense D435 | ¥100-500 | ✅ |
| 🔌 电源 | 12V 5A | ¥30 | ✅ |
| 📋 标定板 | 棋盘格 9x6 | ¥20 | 可选 |
...
| 👁️ **进阶** | [视觉模块](docs/03-vision-pipeline.md) | 理解坐标转换原理 | 30 分钟 |
...
| 步骤 | 坐标系 | 示例 |
|------|--------|------|
| 1️⃣ 像素坐标 | 图像平面 | (640, 360) 像素 |
| 2️⃣ 相机坐标 | 相对摄像头 | (0.1, 0.05, 0.5) 米 |
| 3️⃣ 世界坐标 | 相对机械臂基座 | (0.15, 0.08, 0.3) 米 |
